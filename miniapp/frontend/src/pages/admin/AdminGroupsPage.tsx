...
const AdminGroupsPage: React.FC = () => {
  ...
  const handleSetHeadman = async (studentId: number) => {
    ...
    try {
      ...
      alert('Ошибка назначения старосты')
    }
  }
  ...
  const handleCreateGroup = async () => {
    try {
      ...
      alert(error.response?.data?.detail || 'Ошибка создания группы')
    }
  }
  ...
  const handleEditGroup = async () => {
    ...
    try {
      ...
      alert(error.response?.data?.detail || 'Ошибка обновления группы')
    }
  }
  ...
  const handleDeleteGroup = async (groupId: number) => {
    ...
    try {
      ...
      alert(error.response?.data?.detail || 'Ошибка удаления группы')
    }
  }
