...
**[Смотреть видео с описанием проекта →](https://drive.google.com/drive/folders/1RUwetom9-zsyx9rao5CaL2A5pAX9r7mm)**

В видео представлена полная демонстрация функционала платформы, включая работу чат-бота и веб-миниприложения для всех ролей пользователей.
